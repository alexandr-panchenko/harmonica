...
The workflow installs with a frozen Bun lockfile, typechecks, runs deterministic tests, builds the repository-subpath bundle, selects workflow-based Pages publishing, and deploys the official artifact. Real harmonica and device checks remain exactly those in `manual-test-checklist.md`.
