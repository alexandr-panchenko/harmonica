...
export function App() {
  ...
  if (screen === "menu") return <MainMenu onStart={startMode} onSettings={()=>setShowSettings(true)} profile={profile} playerSetup={playerSetup} settings={showSettings ? settings : null}/>;
...
function MainMenu({onStart,onSettings,settings,profile,playerSetup}:{onStart:(mode:Mode)=>void;onSettings:()=>void;settings:ReactNode;profile:HarmonicaProfile;playerSetup:ReactNode}) {
